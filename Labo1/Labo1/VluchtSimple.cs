...
namespace Labo1
{
    class VluchtSimple
    {
         ...
         * */
        public VluchtSimple(int vluchtNummer, string plaatsBestemming, string plaatsVertrek, DateTime tijdVertrek, DateTime tijdAankomst)
        {
         ...
         */
        public VluchtSimple(int vluchtNummer) : this(vluchtNummer, "Duitsland", "België", DateTime.Now.AddHours(1), DateTime.Now.AddHours(2)) {}
